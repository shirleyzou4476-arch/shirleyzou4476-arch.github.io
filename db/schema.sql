...
CREATE INDEX IF NOT EXISTS scan_events_sku_time_idx ON scan_events(sku, scanned_at);
CREATE INDEX IF NOT EXISTS scan_events_destination_time_idx ON scan_events(destination, scanned_at);
